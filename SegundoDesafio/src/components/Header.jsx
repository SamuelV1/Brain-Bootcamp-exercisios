...
export default function Header() {
    ...
    let mMenu
    if (mobileMenu === true) {
        mMenu = <div className='MobileMenu' id='MobileMenu'> <Menu></Menu><div id="transaparente" onClick={() => setshowMenu(!mobileMenu)}><img src={CloseMenu} alt='Botão De Fechar O Menu'></img></div></div>
    }
    ...
    return (
        <header>
            ...
            <div onClick={() => setshowMenu(!mobileMenu)} id="menu">
                <img src={Menusvg} alt="" />
            </div>
            ...
            <nav className="Register">
                {/*Botoes personalizados feitos em typescript */}
